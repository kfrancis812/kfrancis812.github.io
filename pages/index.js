  ...
  return (
    <>
      ...
      <main className="flex flex-col">
            ...
            <div>
              <nav className="hidden md:flex space-x-4 p-10 font-light" >
                {[
                  ...
                  <a href={url} key={url} className="font-display text-xl font-normal rounded-lg px-3 py-2 text-darkpgray font-medium hover:bg-[#F0E8EB] hover:text-slate-900">{title}</a>
                ))}
              </nav>
            </div>
          </div>
        ...
        <a href="/projects"><button className="pt-2 pb-2 pr-8 pl-8 rounded-full font-display bg-golden text-[#262626] hover:bg-ltgolden tracking-wide">VIEW MORE PROJECTS</button></a>
        </div>
