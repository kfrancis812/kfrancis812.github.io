  ...
  return (
    <>
      ...
      <main className="flex flex-col">
          ...
          <div className="flex flex-row flex-wrap-reverse justify-between text-sm">
            <div className="flex flex-col md:w-6/12">
              <div className="pt-20 md:pl-20 pl-10 font-display text-4xl font-normal text-darkpgray">
                Hey there, <span className="text-[#C46E99]"> Kristin here</span> 👋
          ...
          <div className="flex flex-row text-sm w-full lg:-mt-44 pb-20 md:-mt-18 pt-20">
            <div className="flex flex-col flex-1">
              ...
              <div className="md:pl-20 pl-10  pr-10 md:pr-20 grid grid-cols-1 md:grid-cols-3 gap-4 ">
                <div className="pt-5 flex flex-col w-full bg-[#FBE6C6] rounded-lg p-5">
                ...
                <div className="pt-5 flex flex-col w-full bg-[#FBE6C6] rounded-lg p-5 text-darkpgray">
                  <div className="font-display text-neutral-600 text-base">
        ...
        <span className="text-[#9B7AB8] ">Work</span> &nbsp;&&nbsp; <span className=" text-[#9B7AB8]">Projects</span>
        </div>
        <div className="md:pl-20 pl-10 pt-10 pr-10 md:pr-20  grid grid-cols-1 sm:grid-cols-2 gap-10 text-darkpgray">
        <Link href="/projects/landingpage"><div className="flex flex-col w-full bg-[#5A436F] rounded-lg sm:mb-16">
            <div  >
            ...
            <div className="flex flex-col bg-[#FCFAF8] pt-5 pr-7 pl-7 pb-5 rounded-b-lg ">
          ...
          <Link href="/projects/portfolio"><div className="flex flex-col w-full bg-[#5A436F] rounded-lg sm:mt-16">
            <div >
              <Image className="w-full"
                src="/myportfolio.png"
                alt="Portfolio"
          ...
          <Link href="/projects/watercolor"><div className="flex flex-col w-full bg-[#5A436F] rounded-lg sm:mb-16 sm:-mt-16">
            <div>
              <Image className="w-full"
          ...
          <Link href="/projects/flyer"><div className="flex flex-col w-full bg-[#5A436F] rounded-lg mt-16 -mt-0">
            <div>
              <Image className="w-full"
